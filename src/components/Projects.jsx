...
const Projects = ({ darkMode }) => {
    ...
    return (
        <div data-theme={darkMode ? "dark" : "light"}>
            ...
            <Fade>
                <Container>
                    <h2 className="lead" align="center" style={{paddingBottom:"10px" , paddingTop:"2.3rem"}}><b>- Projects -</b></h2>
                    <Zoom>
                        <Row>
                                ...
                                <Card align="center" className="exp" data-theme={darkMode ? "dark" : "light"}>
                                    ...
                                    <center style={{ height: '336px' }}>
                                        <div className="flip-card" class="flip-card">
                                            <div class="flip-card-inner">
                                                <div className="flip-card-front">
                                                    <Card.Img variant="top" src="https://user-images.githubusercontent.com/100896129/197474549-2a7aeea2-c1d3-4d55-9ad1-3d0401637230.png" />
                                                    <Card.Body>
                                                        <Card.Title align="center">- Clone Of Bitrix24 -</Card.Title>
                                                        <Card.Text>
                                                            <td style={{ fontSize: "14px" }}>
                                                                <p align="center">Features</p>
                                                                <tr>Sign-up & Log-In</tr>
                                    ...
                                    <br />
                                    <div>
                                        <a href="https://bitrixclone.netlify.app/" target="_blank" rel="noreferrer noopener">
                                            <Button variant={darkMode ? "outline-light" : "outline-dark"} className="sbtn">View Project</Button>
                                        </a>
                                        <a href="https://github.com/manish-2396/Bitrix24" target="_blank" rel="noreferrer noopener">
                                            <Button variant={darkMode ? "outline-light" : "outline-dark"} className="sbtn">View Github Repo</Button>
                                        </a>
                                    </div>
                                    <br></br>
